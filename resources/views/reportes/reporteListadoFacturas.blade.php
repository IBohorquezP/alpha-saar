    ...
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-md-1 control-label"><strong>Módulo</strong></label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" value="DOSAS" readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select class="form-control" id="clientefbo-select" name="clientefbo" autocomplete="off">
                            <option value="">--Seleccione un FBO--</option>
                            @foreach($fboClientes as $fbo)
                            <option value="{{$fbo->id}}" {{ (isset($clientefbo) && $clientefbo == $fbo->id) ? 'selected' : '' }}>
                                {{$fbo->nombre}}
                            </option>
                            @endforeach
                        </select>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-condensed">
                                ...
                                <tbody>
                                    @if(count($facturas)>0)
                                    <tr>
                                        <td colspan="12" class="text-center bg-gray" align="center"><strong>DOSAS</strong></td>
                                    </tr>
                                    @foreach($facturas as $index => $factura)
                                    <tr>
                                        <td align="center">{{$index+1}}</td>
                                        <td align="center">{{$factura->fecha}}</td>
                                        <td align="center">{{$factura->nFacturaPrefix}}-{{$factura->nFactura}}</td>
                                        <td align="center">{{$factura->nControlPrefix}}-{{$factura->nControl}}</td>
                                        <td align="center">{{$factura->cliente->cedRifPrefix}}-{{$factura->cliente->cedRif}}</td>
                                        <td align="center">{{$factura->cliente->codigo}}</td>
                                        <td align="left">{{$factura->cliente->nombre}}</td>
                                        <td align="left">{{$factura->descripcion}}</td>
                                        <td align="right" class="DOSAS-subtotal">{{$traductor->format($factura->subtotal)}}</td>
                                        <td align="right" class="DOSAS-iva">{{$traductor->format($factura->iva)}}</td>
                                        <td align="right" class="DOSAS-total">{{$traductor->format($factura->total)}}</td>
                                        <td align="right" class="DOSAS-totalDeudor deuda">{{($factura->estado=='P')?$traductor->format($factura->total):'0,00'}}</td>
                                    </tr>
                                    @endforeach
                                    <tr class="bg-gray">
                                        <td colspan="3" align="left"><strong>TOTAL DOSAS</strong></td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td align="right" id="DOSAS-subtotalTotal">0,00</td>
                                        <td align="right" id="DOSAS-ivaTotal">0,00</td>
                                        <td align="right" id="DOSAS-totalTotal">0,00</td>
                                        <td align="right" id="DOSAS-totalDeudorTotal">0,00</td>
                                    </tr>
                                    <tr class="bg-gray">
                                        <td colspan="3" align="left"><strong>TOTAL GENERAL</strong></td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td> - </td>
                                        <td align="right">{{$traductor->format($subtotal)}}</td>
                                        <td align="right">{{$traductor->format($iva)}}</td>
                                        <td align="right">{{$traductor->format($total)}}</td>
                                        <td align="right" id="totalDeudor">0,00</td>
                                    </tr>
                                    @else
                                    <tr>
